...
- 项目级基础镜像：`192.168.50.50:13000/markz/fund-nav-estimator-backend-base:py3.14-deps-20260524-193621`，由 `backend/Dockerfile.base` 构建，安装 `backend/requirements.txt` 中的运行依赖。
...
docker build -f backend/Dockerfile.base `
  ...
  -t 192.168.50.50:13000/markz/fund-nav-estimator-backend-base:py3.14-deps-20260524-193621 `
  backend

docker push 192.168.50.50:13000/markz/fund-nav-estimator-backend-base:py3.14-deps-20260524-193621
```
