    ...
    <table>
      ...
      <tbody>
        ...
        <tr v-for="fund in funds" :key="fund.fund_code">
          ...
          <td class="fund-cell">
            <RouterLink class="fund-name" :to="`/fund-nav/funds/${fund.fund_code}`">{{ fund.fund_name }}</RouterLink>
          ...
          <td>
            <div class="quick-actions">
              <RouterLink class="link-button" :to="`/fund-nav/funds/${fund.fund_code}`">详情</RouterLink>
