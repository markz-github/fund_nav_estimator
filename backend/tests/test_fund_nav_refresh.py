...
class FundNavRefreshTests(unittest.TestCase):
    ...
    def test_refresh_nav_returns_today_local_nav_without_external_fetch(self) -> None:
    ...
    def test_five_prefix_etf_uses_etf_source_before_open_fund_daily_table(self) -> None:
        ...
        self.assertEqual(snapshot.source, "akshare:etf_spot")
        self.assertEqual(snapshot.nav_date, date(2026, 4, 28))
