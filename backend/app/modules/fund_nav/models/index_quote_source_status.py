...
class IndexQuoteSourceStatus(Base):
    ...
    source_description: Mapped[Optional[str]] = mapped_column(String(1000))
    source_type: Mapped[str] = mapped_column(String(20), nullable=False)
    exclude_rule_type: Mapped[str] = mapped_column(String(20), nullable=False, default="none", server_default="none")
    exclude_rule_value: Mapped[Optional[str]] = mapped_column(String(1000))
